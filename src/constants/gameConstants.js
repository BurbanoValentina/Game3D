...
export const BOOT_MESSAGES = [
  ...
  { text: '║  REGISTRO DE PÉRDIDA — PROTOCOLO VENENO     ║', delay: 1800, type: 'box' },
  { text: '╠══════════════════════════════════════════════╣', delay: 1900, type: 'box' },
  { text: '║  SUYIN_WAVE ···· ELIMINADA PERMANENTEMENTE  ║', delay: 2200, type: 'eliminated' },
  { text: '║  ZURI_APEX ····· ELIMINADA PERMANENTEMENTE  ║', delay: 2600, type: 'eliminated' },
  { text: '║  Causa: Veneno_Zagar — Código irreversible  ║', delay: 3000, type: 'box' },
  { text: '╚══════════════════════════════════════════════╝', delay: 3200, type: 'box' },
